...
# Test Create an ABAP Core Data Services (CDS) View in SAP Cloud Platform, ABAP Environment
...
4. Finally, choose **Use template** then choose **Define view**. Then choose **Finish**.
    ...
    <!-- border -->![step2b-view-with-params](step2b-view-with-params.png)

Your CDS view appears in a new editor.

<!-- border -->![step3a-view-name-data-source](step3a-view-name-data-source.png)
...
2. Insert all the elements from `/DMO/I_TRAVEL_U` by placing your cursor inside the `as select from` statement (curly brackets) and again choosing **Auto-Complete `Ctrl+Space`** .
      ...
      <!-- border -->![step3b-insert-all-elements](step3b-insert-all-elements.png)
